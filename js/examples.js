...
people:
  ...
  - { name: Priya Raman, location: India, role: Developer }
  ...
  - { name: Kwame Mensah, location: Ghana, role: Back End }
  - { name: Elena Petrova, location: Bulgaria, role: Front End }
