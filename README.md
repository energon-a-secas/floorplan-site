...
- **Avatars and display** -- 16x16 characters from the shared Neorgon Avatar Kit: presets in the person sheet, "Use my character" from your Paperdoll cookie, paste a `neoav1:` code, or "Design in Paperdoll"; per-document display options: center seats in a box, shares as bars / badges / hidden, a cat or dog keeping an open seat, pixel or initials, order by name or share, locations on or off
